...
public class HomeController {
	...
	public String deleteByInvoiceNumber(@PathVariable("invoiceNumber") String invoiceNumber) {

		Invoice invoice = invoiceService.getByInvoiceNumber(invoiceNumber);
		if (!(invoice==null)) {
			invoiceService.deleteByInvoiceNumber(invoiceNumber);
			return "Deleted details :" + invoiceNumber;
		} else {
			throw new DetailsNotFoundException(invoiceNumber + " not found");
		}
